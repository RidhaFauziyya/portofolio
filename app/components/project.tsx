...
export default function ProjectCard({
  ...
  return (
    <div className="grid overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03]">
      <div className="flex flex-col p-4 lg:col-span-3">
        ...
        <div className="mt-auto flex gap-6 pt-8 text-white items-center text-xs">
          <Link
            href={url}
            target="_blank"
